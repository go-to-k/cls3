...
func (s *S3Wrapper) ClearS3Objects(ctx context.Context, bucketName string, forceMode bool, quiet bool, oldObjectsOnly bool) error {
	...
	versions, err := s.client.ListObjectVersions(ctx, aws.String(bucketName), region, oldObjectsOnly)
	if err != nil {
		return err
	}
